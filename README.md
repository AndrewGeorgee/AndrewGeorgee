...
| **Mobile** | ![Flutter](https://img.shields.io/badge/-Flutter-02569B?logo=flutter&logoColor=white) iOS Native, Android Native, BLoC, Riverpod, GetX, MethodChannels |
| **Architecture** | Clean Architecture, MVVM, SOLID Principles, Modular Design |
| **Backend & Cloud** | ![Firebase](https://img.shields.io/badge/-Firebase-FFCA28?logo=firebase&logoColor=black) Firestore, Cloud Functions, Supabase, API Integration |
| **Tools & DevOps** | ![Git](https://img.shields.io/badge/-Git-F05032?logo=git&logoColor=white) ![Docker](https://img.shields.io/badge/-Docker-2496ED?logo=docker&logoColor=white) CI/CD, Figma, Monorepos |
